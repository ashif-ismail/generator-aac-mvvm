...
import <%= appPackage %>.R;
import <%= appPackage %>.databinding.FragmentHomeBinding;
import <%= appPackage %>.di.components.Injectable;
import <%= appPackage %>.util.AppConstants.Status;
import <%= appPackage %>.util.DialogUtils;
import <%= appPackage %>.view.adapter.ContentAdapter;
